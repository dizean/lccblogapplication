...
export const visitorLogin = () => {
  ...
  return useMutation({
    mutationFn: ({ name, purpose, gate, id, image, descriptor, mode }: { name: string; purpose: string; gate: string; id: string; image: string, descriptor: string, mode: "NEW" | "EXISTING" }) =>
